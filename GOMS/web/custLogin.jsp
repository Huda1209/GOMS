<%-- 
    Document   : custLogin
    Created on : Jan 22, 2022, 9:21:16 PM
    Author     : Hp
--%>
...
<%@page import="java.sql.*" %>
             ...
             <% try {
                ...
                if(request.getParameter("btn_login") != null) {
                    ...
                    email=request.getParameter("custID");
                    password=request.getParameter("password");
                    
                    PreparedStatement ps = null;
                    
                    ps=con.prepareStatement("select *from customer where custID=? AND password=?");
...
<html>
    ...
    <body style="font-family: 'Poppins', sans-serif;">
        <script>
                    function validate() {
                        var email = document.myform.custID;
...
<div class="wrapper">
    ...
    <form name="myForm" class="p-3 mt-3" method="post" onsubmit="return validate();">
        <%
                    ...
                    %>
                    <div class="form-field d-flex align-items-center"> <span class="fa fa-user"></span> <input type="text" name="custID" id="custID" placeholder="Your ID" required=""> </div>
