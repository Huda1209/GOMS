<%-- 
    Document   : addTrainer
    Created on : Jan 13, 2022, 2:25:07 AM
    Author     : Hp
--%>
                ...
                <div class="col-lg-8 col-xl-6">
                  <div class="card rounded-3">
                    ...
                    <div class="card-body p-4 p-md-5">
                      ...
                      <form class="px-md-2" action="processTrainerList.jsp">
                        ...
                        <button name="Submit" type="submit" value="Submit" class="btn btn-success btn-lg mb-1" style="background-color: #302d2d;">Add</button>
                        <button name="Cancel" type="Cancel" value="Cancel" onclick="document.history.back();" class="btn btn-success btn-lg mb-1" style="background-color: #302d2d;">Cancel</button>
                      </form>
