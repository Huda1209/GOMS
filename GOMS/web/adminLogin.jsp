<%-- 
    Document   : adminLogin
    Created on : Jan 17, 2022, 9:59:10 PM
    Author     : Hp
--%>
...
<%
            try {
                ...
                if(request.getParameter("btn_login") != null) {
                    ...
                    email=request.getParameter("adminID");
...
<html>
    ...
    <body style="font-family: 'Poppins', sans-serif;">
        <script>
                    function validate() {
                        var email = document.myform.adminID;
...
<div class="wrapper">
    <div class="logo"></div>
    <a href="adminMain.jsp"><div class="text-center mt-4 name"> SIGN IN </div></a>
    <form name = "myform" class="p-3 mt-3" method="POST" onsubmit="return validate();">
        ...
        <div class="form-field d-flex align-items-center"> <span class="fa fa-user"></span> <input type="text" name="adminID" id="adminID" placeholder="Your ID" required> </div>
        <div class="form-field d-flex align-items-center"> <span class="fa fa-key"></span> <input type="password" name="password" id="password" placeholder="Password" required> </div> 
        <button class="btn mt-3" name="btn_login">Login</button>
    </form>
