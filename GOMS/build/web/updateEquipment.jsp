<%-- 
    ...
    Created on : Jan 23, 2022, 10:13:38 PM
    Author     : Hp
--%>
...
<html>
  ...
  .h-custom {
    ...
    <%
        ...
        Equipment equipment = dao.retrieveOneEquipment(equipmentId);
        db.closeConnection();
       %>
    <body>
                ...
                <div class="col-lg-8 col-xl-6">
                  <div class="card rounded-3">
                    ...
                    <div class="card-body p-4 p-md-5">
                      ...
                      <form class="px-md-2" action="processEquipUpdate.jsp" method="post">
                          <input type="hidden" name="hidid" value="<%=equipment.getId()%>"/>
          
                        <div class="form-outline mb-4">
                            <label class="form-label" for="equipID">Equipment ID</label>
                            <input type="text" name="equipID" class="form-control" value="<%=equipment.getEquipID()%>" />
                          </div>

                        <div class="form-outline mb-4">
                          <label class="form-label" for="equipName">Equipment Name</label>
                          <input type="text" name="equipName" class="form-control" value="<%=equipment.getEquipName()%>" />
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6 mb-4">
                            ...
                            <select name="category">
                                <option value="<%=equipment.getCategory()%>" disabled="">Body Part</option>
                        ...
                        <div class="row mb-4 pb-2 pb-md-0 mb-md-5">
                          <div class="col-md-6">
                            ...
                            <div class="form-outline">
                              ...
                              <input type="text" name="noOfEquip" class="form-control" value="<%=equipment.getNoOfEquip()%>" />
                            </div>
          
                          </div>
                        </div>
          
                          <button type="submit" value="Submit" name="Submit" class="btn btn-success btn-lg mb-1" style="background-color: #302d2d;">Update</button>
